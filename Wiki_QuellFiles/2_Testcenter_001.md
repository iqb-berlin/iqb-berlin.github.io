...
<tr>
    ...
    <td>" "</td>
    <td>Datum</td>
    <td>Frei wählbarer Wert. Der Name muss in gleicher Schreibweise auch in der Testtakers.xml aufgeführt sein, damit dieses Booklet aufgerufen wird!</td>
</tr>
<tr>
    <td>Label:</td>
    <td>" "</td>
...
<tr>
    ...
    <td>key</td>
    <td>Attribut</td>
    <td>Vordefinierter Wert. Ermöglicht eine Booklet Konfiguration. Die möglichen zu verwendenen Werte entnehmen Sie bitte der **Booklet Konfiguration** im Kapitel:<br><a href="https://github.com/iqb-berlin/iqb-berlin.github.io/wiki/2.5-Konfiguration-der-Testdurchf%C3%BChrung">Konfiguration der Testdurchführung</a></td>
</tr>
<tr>
    <td>Config:</td>
    <td>" "</td>
    <td>Datum</td>
    <td>Vordefinierter Wert. Die möglichen zu verwendenen Werte entnehmen Sie bitte der **Booklet Konfiguration** im Kapitel:<br><a href="https://github.com/iqb-berlin/iqb-berlin.github.io/wiki/2.5-Konfiguration-der-Testdurchf%C3%BChrung">Konfiguration der Testdurchführung</a></td>
</tr>
